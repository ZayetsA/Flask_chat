...
from db import get_user, save_user, save_room, add_room_members, get_rooms_for_user, get_room, is_room_member, \
    get_room_members, is_room_admin, update_room, remove_room_members, remove_room, save_message, get_messages

app = Flask(__name__)
app.secret_key = "Hey, i'm secret!"
socket = SocketIO(app)
...
def handle_send_message_event(data):
    ...
    file.write(str(now) + " " + data['username'] + ":" + data['message'] + "\n")
    file.close()
...
def handle_join_room_event(data):
    ...
    file = open("log/" + data['room'] + ".log", "a")
    file.write(str(now) + " " + data['username'] + ":" + "has joined the room" + ":" + data['room'] + "\n")
    file.close()
    join_room(data['room'])
...
def handle_leave_room_event(data):
    ...
    file = open("log/" + data['room'] + ".log", "a")
    file.write(str(now) + " " + data['username'] + ":" + "has left the room" + ":" + data['room'] + "\n")
    file.close()
